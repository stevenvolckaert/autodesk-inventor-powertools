...
{
    /// <summary>
    /// Provides extension methods for Inventor.DrawingCurve objects.
    /// </summary>
    public static class DrawingCurveExtensions
    {
        ...
        /// </summary>
        /// <param name="drawingCurve">The Inventor.DrawingCurve object that this extension method affects.</param>
        ...
        public static bool IsBendLine(this DrawingCurve drawingCurve)
        {
            if (drawingCurve == null)
                throw new ArgumentNullException("drawingCurve");

            return drawingCurve.IsLine() && (drawingCurve.EdgeType == DrawingEdgeTypeEnum.kBendDownEdge || drawingCurve.EdgeType == DrawingEdgeTypeEnum.kBendUpEdge);
        }
        ...
        public static bool IsLine(this DrawingCurve drawingCurve)
        {
            ...
            return drawingCurve.CurveType == CurveTypeEnum.kLineCurve || drawingCurve.CurveType == CurveTypeEnum.kLineSegmentCurve;
        }
        ...
        public static bool IsHorizontal(this DrawingCurve drawingCurve)
        {
            ...
            return drawingCurve.StartPoint == null || drawingCurve.EndPoint == null
                ? false
                : Math.Abs(drawingCurve.StartPoint.Y - drawingCurve.EndPoint.Y) <= Math.Abs(drawingCurve.StartPoint.Y * .0001);
        }
        ...
        public static bool IsVertical(this DrawingCurve drawingCurve)
        {
            ...
            return drawingCurve.StartPoint == null || drawingCurve.EndPoint == null
                ? false
                : Math.Abs(drawingCurve.StartPoint.X - drawingCurve.EndPoint.X) <= Math.Abs(drawingCurve.StartPoint.X * .0001);
        }
    }
}
